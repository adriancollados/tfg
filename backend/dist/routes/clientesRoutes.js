 ...
 *         description: Error interno del servidor
 */
router.post('/clientes/register', [body('EMAIL').isEmail().withMessage("El campo debe ser un email"), body('PASS').isLength({
  min: 6
}).withMessage("Contraseña debe tener mínimo 6 dígitos de longitud"), body('TELEFONO').isInt().withMessage("Deben ser números enteros")], clienteController.registro);
 ...
 *         description: Error interno del servidor
 */
router.put('/clientes/perfil/:id', [body('TELEFONO').optional().isInt().withMessage("TELEFONO debe ser un número entero")], isAuthenticated, clienteController.editarPerfil);
