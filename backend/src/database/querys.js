export const queries = {
	...
	getClienteId: 'select CODCLIENTE, NOMBRECLIENTE, CIF, DIRECCION1, CODPOSTAL, POBLACION, PROVINCIA, TELEFONO, EMAIL from CLIENTES with(nolock) where codcliente = @id',
	spClientes: 'PR_CLIENTES_INSERT',

	addCliente: 'insert into clientes(CODCLIENTE, NOMBRECLIENTE, CIF, DIRECCION, CODPOSTAL, POBLACION, PROVINCIA, TELEFONO, EMAIL, PASS, FECHAALTA) values(@CODCLIENTE, @NOMBRECLIENTE, @CIF, @DIRECCION1, @CODPOSTAL, @POBLACION, @PROVINCIA, @TELEFONO, @E_MAIL, @PASS, GETUTCDATE())',
