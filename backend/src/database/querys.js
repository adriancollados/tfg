export const queries = {
	...
	addCliente: 'insert into clientes(CODCLIENTE, NOMBRECLIENTE, DIRECCION, TELEFONO, EMAIL, PASS, FECHAALTA) values(@CODCLIENTE, @NOMBRECLIENTE, @DIRECCION, @TELEFONO, @EMAIL, @PASS, GETUTCDATE())',
